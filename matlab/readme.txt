    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying C and C++ standalone applications, it is 
              possible to run the shell script file run_main.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    All Platforms:
        * main.ctf (If present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * main.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * main (application created by MATLAB Compiler)
        * run_main.sh (shell script that can be run to 
    ...
    All Platforms:
        * main.dylib (shared library, file extension varies by 
          platform)
        * main.h (library header file)
        * main.ctf (If present)(Component Technology File archive,
    ...
    Windows:
        * main.ctf (Component Technology File archive, contains 
          compiled M-code)    
        * main.xml (documentation files)
        * main.pdb (program database file - if DEBUG option 
          selected)
        * main.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    All Platforms: 
        * main.jar (Java class files and compiled M-code)
    ...
    Windows:
        ...
        * main.ctf (Component Technology File archive, contains 
          compiled M-code)
        * main.xla (Optionally created and placed in
